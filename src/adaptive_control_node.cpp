...
class HandRosMaster 
{
  public:
    ...
    bool init(){
        ...
        _controller = std::make_shared<control::ad_control::ADControl>(_allgeroHand,_controlParams,_dt);
        ...
        // file for saving
        std::string _fileName = "adaptive_test_gY_9";
  ...
  protected:
    ...
    std::shared_ptr<control::ad_control::ADControl> _controller;
